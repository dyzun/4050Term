<%-- 
    Document   : updateplayerprofile
    Created on : Apr 21, 2017, 5:19:06 PM
    Author     : josep
--%>
                ...
                <div class="grid_8">
                    <div class="left-1">
                        ...
                        <form action="Servlet" method="post">
                            <fieldset>
                                <label><strong>Current Name of Player:</strong><br>
                                    <input type="text" id="currentname" name="currentname" value="" style="width:200px;">
                                </label><br>
                                <label><strong>Current ID of Player:</strong><br>
                                    <input type="number" id="currentid" name="currentid" value="" style="width:200px;">
                                </label>
                                <br><br>
                                <label><strong>Name:</strong>
                                    <input type="text" id="newname" name="newname" value="" style="width:200px;">
                                </label><br>
                                <label><strong>Phone:</strong>
                                    <input type="text" id="newphone" name="newphone" value="" style="width:200px;">
                                </label><br>
                                <label><strong>Team:</strong>
                                    <input type="text" id="newteam" name="newteam" value="" style="width:200px;">
                                </label>

                                <div class="btns"><button name="updateplayerprofilebutton" class="btn">Update</button></div>
                            </fieldset>
                        </form>
                    </div>
                </div>
