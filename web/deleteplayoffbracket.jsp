<%-- 
    Document   : deleteplayoffbracket
    Created on : Apr 21, 2017, 6:21:23 PM
    Author     : josep
--%>
...
<html lang="en">
    <head>
        <title>Delete Playoff Tournament</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section id="content">
            <div class="container_12 top-4">
                ...
                <div class="grid_8">
                    <div class="left-1">
                        <h2>Delete Playoff Tournament</h2><br>
                        <label>Select Tournament Name:</label>
                        <select>
                        ...
                        <form method="post" action="#">
                            <center><button href="#" type="button">Delete</button></center>
                        </form>
                    </div>
                </div>
                <div class="clear"></div>
